    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff", }}>
      {isData ? (
        ...
        <View style={{alignItems:'center'}}>
          ...
          <View style={{ flex: 2, padding: 10, flexDirection: "column", marginBottom:10, borderRadius:10, borderStyle:'solid', borderWidth:1, borderColor:'#666'  }}>
            <Text
              style={{
            ...
            >
              ...
              <Text style={{ textAlign: "center", fontSize: 17 }}> {data['rcnumber']}</Text>
            </View>
            <View
              style={{
                flexDirection: "row",
            ...
            >
              <View style={{ flexDirection: "row" }}>
                <MaterialIcons
                  ...
                  style={{ marginRight: 5 }}
                />
                <Text style={{ fontWeight: "bold", fontSize: 17 }}>Address :</Text>
              </View>
              <Text style={{ textAlign: "center", fontSize: 17 }}> {data['address']}</Text>
            </View>
